...
* **Towards Real-Time ML Approximations of AC Optimal Power Flow** (IEEE, May 2025)
* **Motion-Resilient Deep Learning for ECG Signal Classification** (IEEE, Mar 2025)
* **Adaptive Parameter Optimization in Gaussian Processes** (arXiv, Jul 2025)
